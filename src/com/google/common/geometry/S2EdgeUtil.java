...
import com.google.common.base.PreconditionsCopy;
...
public strictfp class S2EdgeUtil {
  ...
  public static S2Point getIntersection(S2Point a0, S2Point a1, S2Point b0, S2Point b1) {
    PreconditionsCopy.checkArgument(robustCrossing(a0, a1, b0, b1) > 0,
  ...
  public static double getDistanceFraction(S2Point x, S2Point a0, S2Point a1) {
    PreconditionsCopy.checkArgument(!a0.equals(a1));
  ...
  public static S1Angle getDistance(S2Point x, S2Point a, S2Point b, S2Point aCrossB) {
    PreconditionsCopy.checkArgument(S2.isUnitLength(x));
    PreconditionsCopy.checkArgument(S2.isUnitLength(a));
    PreconditionsCopy.checkArgument(S2.isUnitLength(b));
